...
export default function Home(props) {
  const posts = props.portfolio[14].subProjects[7];
      ...
      <div className={styles.portfolioContent}>
        ...
        <div className={`${styles.feature} ${styles.featureAlt}`}>
          ...
          <div className={styles.content}>
            ...
            <p>Each question has a 'Yes' or a 'No' answer, which once answered displays the next question in the line.<br></br><br></br>Within the code I have used some IF statements and pull the correct content from the content.js file.<br></br><br></br>Once all questions in teh line has been answered the user will be given an instruction.</p>
          </div>
        </div>
