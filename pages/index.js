    ...
    <div>
      ...
      <section className={styles.homePage}>
          <div className={styles.homeContent}>
            ...
            <p className='large'>I'm a web developer currently travelling around Australia, specializing in custom-built WordPress websites. I also have experience with Shopify, React, and SEO.</p>
