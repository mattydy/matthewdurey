    ...
    <div>
      <section className='container'>
          ...
          <div className={styles.innerPage}>
            ...
            <p>Feel free to have a look through <Link href="/portfolio/"><a>my portfolio</a></Link> to see what I've been working on, connect with me via <Link href="https://www.linkedin.com/in/matthew-durey-2511a6142"><a target="_blank">LinkedIn</a></Link>, or <Link href="/contact/"><a>get in touch</a></Link> to talk about collaborating.</p>
