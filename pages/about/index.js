  ...
  return (
    <div>
      <section className='container'>
          ...
          <h2>Web Developer<span>,</span> Keen Golder <span>&</span> Avid Traveller<span>.</span></h2>
          <div className={styles.innerPage}>
            ...
            <p>In 2024, I spent nine months living and travelling in Australia and Indonesia. In June 2025, I co-founded <Link href="https://3point.digitalutm_source=matthewdurey&utm_medium=about_page"><a target='_blank'>Triple Point Digital</a></Link>, a digital agency providing website design, development and support. In October 2025 I joined the Goldcrest Group, where I oversee the development of the group's portfolio of websites.</p>
