          ...
          <div className={styles.innerPage}>
            ...
            <div className={styles.innerPage__fullText}>
              <div className={styles.innerPage__half}>
                ...
                <p>Are you looking for an indepth bespoke site to promote your business, or perhaps you want to create a blog of some kind? If so WordPress is the solution for you.<br></br><br></br>Using custom fields and the Gutenburg Editor, you can create and manage content for your site really easily.<br></br><br></br>All Wordpress websites also come with a customised 'How To' document to show you the best way of working and how to get the most out of your website.</p>
